...
public class NavBar<T> extends BasePage<T> {
    ...
    public String getGreatingMsg() {
        ...
        String message = getInnerText(welcomeMsgLink, getDriver());
